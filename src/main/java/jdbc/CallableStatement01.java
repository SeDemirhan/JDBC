...
public static void main(String[] args) throws ClassNotFoundException, SQLException {
    ...
    //4.Adım: Return için registerOutParameter() methodunu , parametreler için ise set() methodlarından
    ...
    //5.Adım: Çalıstırmak için execute() methodunu kullan
    cst1.execute();

    //6.Adım: Sonucu çağrmak için return data tipine göre "get" methodlarından uygun olanı kullan
